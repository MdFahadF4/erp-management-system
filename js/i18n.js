...
const STRINGS = {
  en: {
    ...
    'allTxn.tabMasterAudit': 'Master Audit',
    'allTxn.tabUserTransactions': 'User Transactions',
    'allTxn.filterByUser': 'User',
    'allTxn.userTodayHint': "Shows today's entries for the selected user by default.",
